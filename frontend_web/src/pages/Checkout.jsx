...
const Checkout = () => {
  ...
  const loadDistricts = async (provinceCode) => {
    ...
    try {
      const response = await fetch(
        `${PROVINCE_API_URL}/provinces/${provinceCode}/districts?limit=100`,
        {
          headers: {
            Authorization: `Bearer ${PROVINCE_API_TOKEN}`,
            "Content-Type": "application/json",
  ...
  const loadWards = async (districtCode) => {
    ...
    try {
      const response = await fetch(
        `${PROVINCE_API_URL}/districts/${districtCode}/wards?limit=100`,
        {
          headers: {
            Authorization: `Bearer ${PROVINCE_API_TOKEN}`,
            "Content-Type": "application/json",
      ...
      <div className="checkout-content">
        ...
        <div className="checkout-left">
          ...
          <div className="section-card">
            ...
            <button className="btn-add-address" onClick={handleShowAddressForm}>
